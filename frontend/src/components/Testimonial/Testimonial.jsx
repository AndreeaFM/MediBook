      ...
      >
        ...
        <SwiperSlide>
          <div className="py-[30px] px-5 rounded-3">
            ...
            <p className="text-[16px] leading-7 mt-4 ">
              "Their medical care is awesome. Their treatment is exceptional,
              and they offer top-notch medical services."
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="py-[30px] px-5 rounded-3">
            ...
            <p className="text-[16px] leading-7 mt-4 ">
              "Medical services at high level. They treat so well and they are
        ...
        <SwiperSlide>
          <div className="py-[30px] px-5 rounded-3">
            ...
            <p className="text-[16px] leading-7 mt-4 ">
              "Excellent treatment and high-quality medical services provided
              during my visits."
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="py-[30px] px-5 rounded-3">
            ...
            <p className="text-[16px] leading-7 mt-4 ">
              "Their exceptional treatment and the excellent medical services
              they provide were evident during my visits."
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="py-[30px] px-5 rounded-3">
            ...
            <p className="text-[16px] leading-7 mt-4 ">
              "During my visits, I have experienced their exceptional treatment
              and the excellent medical services they provide."
            </p>
          </div>
        </SwiperSlide>
      </Swiper>
