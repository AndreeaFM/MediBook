      ...
      <div className="max-w-[1170px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            <h3 className="text-headingColor text-[22px] leading-9 font-bold nb-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mb-5 flex items-center justify-between">
                <label className="text-headingColor font-bold font-[16px] leading-7">
                  Are you a:
                  <select
                    name="role"
                    value={formData.role}
              ...
              <div className="mb-5 flex items-center gap-3 ">
                ...
                <div className="relative w-[130px] h-[50px]">
                  ...
                  <label
                   ...
                   text-headingColor font-semibold rounded rounded-lg truncate cursor-pointer"
                  >
                    Upload Photo
                  </label>
                </div>
